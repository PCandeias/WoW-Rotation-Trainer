...
export const PLAYER_EFFECT_BUFF_REGISTRY: BuffRegistry = {
  ...
  mystic_touch: { iconName: 'ability_monk_sparring', emoji: '👊', displayName: 'Mystic Touch' },
  chaos_brand: { iconName: 'ability_demonhunter_empowerwards', emoji: '💜', displayName: 'Chaos Brand' },
  hunters_mark: { iconName: 'ability_hunter_markedfordeath', emoji: '🎯', displayName: "Hunter's Mark" },
