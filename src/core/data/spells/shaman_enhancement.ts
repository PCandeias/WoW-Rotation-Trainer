...
const SPELLS: SpellDef[] = [
  createSpell({ id: 17364, name: 'stormstrike', displayName: 'Stormstrike', cooldown: 7.5, hasteScalesCooldown: true, isPhysical: true }),
  createSpell({ id: 32175, name: 'stormstrike_mh', displayName: 'Stormstrike (Main Hand)', isPhysical: true }),
  createSpell({ id: 32176, name: 'stormstrike_offhand', displayName: 'Stormstrike (Off Hand)', isPhysical: true }),
  createSpell({ id: 390287, name: 'stormblast_stormstrike_mh', displayName: 'Stormblast Stormstrike (Main Hand)', isPhysical: false }),
  createSpell({ id: 390287, name: 'stormblast_stormstrike_offhand', displayName: 'Stormblast Stormstrike (Off Hand)', isPhysical: false }),
  createSpell({ id: 60103, name: 'lava_lash', displayName: 'Lava Lash', cooldown: 18, hasteScalesCooldown: true, isPhysical: false, talentRequired: 'lava_lash' }),
  createSpell({ id: 187874, name: 'crash_lightning', displayName: 'Crash Lightning', cooldown: 15, hasteScalesCooldown: true, isPhysical: false, talentRequired: 'crash_lightning' }),
  ...
  createSpell({ id: 384352, name: 'doom_winds', displayName: 'Doom Winds', cooldown: 60, isOnGcd: false, talentRequired: 'doom_winds' }),
  ...
  createSpell({ id: 455590, name: 'tremor_es', displayName: 'Earthsurge', isPhysical: false }),
  createSpell({ id: 3606, name: 'searing_bolt', displayName: 'Searing Bolt', isPhysical: false }),
  createSpell({ id: 458147, name: 'searing_volley', displayName: 'Searing Volley', isPhysical: false }),
  ...
  createSpell({ id: 344357, name: 'stormflurry', displayName: 'Stormflurry', isPhysical: true, talentRequired: 'stormflurry' }),
  createSpell({ id: 344357, name: 'stormflurry_stormstrike', displayName: 'Stormflurry', isPhysical: true, talentRequired: 'stormflurry' }),
  createSpell({ id: 344357, name: 'stormflurry_windstrike', displayName: 'Stormflurry', isPhysical: true, talentRequired: 'stormflurry' }),
  createSpell({ id: 384444, name: 'thorims_invocation', displayName: 'Thorim\'s Invocation Trigger', isPhysical: false, talentRequired: 'thorims_invocation' }),
  createSpell({ id: 188196, name: 'lightning_bolt_ti', displayName: 'Lightning Bolt (Thorim\'s Invocation)', isPhysical: false }),
  createSpell({ id: 188443, name: 'chain_lightning_ti', displayName: 'Chain Lightning (Thorim\'s Invocation)', isPhysical: false }),
  createSpell({ id: 289874, name: 'ride_the_lightning', displayName: 'Ride the Lightning Trigger', isPhysical: false, talentRequired: 'ride_the_lightning' }),
  createSpell({ id: 211094, name: 'chain_lightning_ll_rtl', displayName: 'Chain Lightning (Ride the Lightning: Lava Lash)', isPhysical: false }),
  createSpell({ id: 211094, name: 'chain_lightning_ss_rtl', displayName: 'Chain Lightning (Ride the Lightning: Stormstrike)', isPhysical: false }),
  createSpell({ id: 211094, name: 'chain_lightning_ws_rtl', displayName: 'Chain Lightning (Ride the Lightning: Windstrike)', isPhysical: false }),
  createSpell({ id: 115357, name: 'windstrike_mh', displayName: 'Windstrike (Main Hand)', isPhysical: true }),
  createSpell({ id: 115360, name: 'windstrike_offhand', displayName: 'Windstrike (Off Hand)', isPhysical: true }),
  ...
  createSpell({ id: 115356, name: 'windstrike', displayName: 'Windstrike', cooldown: 7.5, hasteScalesCooldown: true, isPhysical: true }),
];
...
const BUFFS: BuffDef[] = [
  ...
  { id: 'cl_crash_lightning', displayName: 'Crash Lightning', duration: 15, maxStacks: 3, isHarmful: false },
  ...
  { id: 'flurry', displayName: 'Flurry', duration: 15, maxStacks: 3, isHarmful: false },
  { id: 'lively_totems', displayName: 'Lively Totems', duration: 8, maxStacks: 10, isHarmful: false, stackExpirationModel: 'separate' },
  { id: 'searing_totem', displayName: 'Searing Totem', duration: 8.85, maxStacks: 10, isHarmful: false, stackExpirationModel: 'separate' },
  ...
  { id: 'lightning_strikes', displayName: 'Lightning Strikes', duration: 30, maxStacks: 3, isHarmful: false },
  ...
  { id: 'molten_weapon', displayName: 'Molten Weapon', duration: 8, maxStacks: 30, isHarmful: false },
  { id: 'icy_edge', displayName: 'Icy Edge', duration: 8, maxStacks: 30, isHarmful: false },
  { id: 'crackling_surge', displayName: 'Crackling Surge', duration: 8, maxStacks: 30, isHarmful: false, stackExpirationModel: 'separate' },
  ...
  { id: 'elemental_overflow', displayName: 'Elemental Overflow', duration: 20, maxStacks: 1, isHarmful: false },
